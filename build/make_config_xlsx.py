...
ALL_FEATURES_V2 = [
    ...
    ("Core",           "backup"),
    ("Productivity",   "sticky_voucher_date"),
    ("Productivity",   "multi_party_voucher"),
    ("Users",          "multi_user_2"),
    ("Users",          "multi_user_5"),
    ...
    ("Reconciliation", "bank_reco_split"),
    ("Reconciliation", "ledger_reconciliation"),
    ("Reconciliation", "ledger_reco_split"),
...
PLAN_FEATURE_MATRIX = {
    "DEMO": {
        ...
        "sticky_voucher_date", "multi_party_voucher",
        "multi_user_unlimited",
        *ALL_REPORT_FEATURES,
        "export_excel", "export_pdf", "print", "email_report",
        "bank_reconciliation", "bank_reco_split",
        "ledger_reconciliation", "ledger_reco_split", "book_migration",
        "gst", "tds",
...
FEATURE_UPGRADE_MAP_SEED = {
    **{fid: "STANDARD" for fid in ALL_REPORT_FEATURES},
    ...
    "sticky_voucher_date":   "STANDARD",
    "multi_party_voucher":   "STANDARD",
    "gst":                   "PRO",
    "tds":                   "PRO",
