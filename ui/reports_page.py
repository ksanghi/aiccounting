...
class GSTR2BReconPage(_ReportBase):
    ...
    def _extra_filters(self, row):
        ...
        row.addWidget(btn)
        # NOTE: the "Pull from portal" / "Pull free (direct login)" buttons were
        # removed — the direct GSTR-2B portal pull (backlog A17) has no reliable
        # solution. Reconciliation stays via the manual "Load GSTR-2B…" file path.
